...
class FrameListener(Node):
  ...
  def odometry(self, msg):
      ...
      # Publish the 2D pose
      # self.current_x = msg.transforms[8].transform.translation.x
      # self.current_y = msg.transforms[8].transform.translation.y    
      # roll, pitch, yaw = self.euler_from_quaternion(
      # msg.transforms[8].transform.rotation.x,
      # msg.transforms[8].transform.rotation.y,
      # msg.transforms[8].transform.rotation.z,
      # msg.transforms[8].transform.rotation.w)      
