...
static size_t _Discover_Goal__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Discover_Goal(full_bounded, 0);
}
...
static size_t _Discover_Result__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Discover_Result(full_bounded, 0);
}
...
static size_t _Discover_Feedback__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Discover_Feedback(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const explorer_interfaces::action::Discover_Goal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
static size_t _Discover_SendGoal_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Discover_SendGoal_Request(full_bounded, 0);
}
...
static size_t _Discover_SendGoal_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Discover_SendGoal_Response(full_bounded, 0);
}
...
static size_t _Discover_GetResult_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Discover_GetResult_Request(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const explorer_interfaces::action::Discover_Result &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
static size_t _Discover_GetResult_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Discover_GetResult_Response(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const explorer_interfaces::action::Discover_Feedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
static size_t _Discover_FeedbackMessage__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Discover_FeedbackMessage(full_bounded, 0);
}
