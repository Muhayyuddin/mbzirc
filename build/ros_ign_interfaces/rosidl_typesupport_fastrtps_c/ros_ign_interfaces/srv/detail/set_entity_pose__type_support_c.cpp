...
static size_t _SetEntityPose_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ros_ign_interfaces__srv__SetEntityPose_Request(
    full_bounded, 0);
}
...
static size_t _SetEntityPose_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ros_ign_interfaces__srv__SetEntityPose_Response(
    full_bounded, 0);
}
