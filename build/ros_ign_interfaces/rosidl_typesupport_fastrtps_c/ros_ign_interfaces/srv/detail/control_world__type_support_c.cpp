...
static size_t _ControlWorld_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ros_ign_interfaces__srv__ControlWorld_Request(
    full_bounded, 0);
}
...
static size_t _ControlWorld_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ros_ign_interfaces__srv__ControlWorld_Response(
    full_bounded, 0);
}
