...
{
  explorer_interfaces__action__Discover_Goal * msg = (explorer_interfaces__action__Discover_Goal *)malloc(sizeof(explorer_interfaces__action__Discover_Goal));
  if (!msg) {
    return NULL;
  }
...
explorer_interfaces__action__Discover_Goal__Sequence__init(explorer_interfaces__action__Discover_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (explorer_interfaces__action__Discover_Goal *)calloc(size, sizeof(explorer_interfaces__action__Discover_Goal));
    if (!data) {
      return false;
    }
...
{
  explorer_interfaces__action__Discover_Goal__Sequence * array = (explorer_interfaces__action__Discover_Goal__Sequence *)malloc(sizeof(explorer_interfaces__action__Discover_Goal__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  explorer_interfaces__action__Discover_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    explorer_interfaces__action__Discover_Goal * data =
      (explorer_interfaces__action__Discover_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!explorer_interfaces__action__Discover_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          explorer_interfaces__action__Discover_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  explorer_interfaces__action__Discover_Result * msg = (explorer_interfaces__action__Discover_Result *)malloc(sizeof(explorer_interfaces__action__Discover_Result));
  if (!msg) {
    return NULL;
  }
...
explorer_interfaces__action__Discover_Result__Sequence__init(explorer_interfaces__action__Discover_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (explorer_interfaces__action__Discover_Result *)calloc(size, sizeof(explorer_interfaces__action__Discover_Result));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  explorer_interfaces__action__Discover_Result__Sequence * array = (explorer_interfaces__action__Discover_Result__Sequence *)malloc(sizeof(explorer_interfaces__action__Discover_Result__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  explorer_interfaces__action__Discover_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    explorer_interfaces__action__Discover_Result * data =
      (explorer_interfaces__action__Discover_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!explorer_interfaces__action__Discover_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          explorer_interfaces__action__Discover_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  explorer_interfaces__action__Discover_Feedback * msg = (explorer_interfaces__action__Discover_Feedback *)malloc(sizeof(explorer_interfaces__action__Discover_Feedback));
  if (!msg) {
    return NULL;
  }
...
explorer_interfaces__action__Discover_Feedback__Sequence__init(explorer_interfaces__action__Discover_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (explorer_interfaces__action__Discover_Feedback *)calloc(size, sizeof(explorer_interfaces__action__Discover_Feedback));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  explorer_interfaces__action__Discover_Feedback__Sequence * array = (explorer_interfaces__action__Discover_Feedback__Sequence *)malloc(sizeof(explorer_interfaces__action__Discover_Feedback__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  explorer_interfaces__action__Discover_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    explorer_interfaces__action__Discover_Feedback * data =
      (explorer_interfaces__action__Discover_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!explorer_interfaces__action__Discover_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          explorer_interfaces__action__Discover_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  explorer_interfaces__action__Discover_SendGoal_Request * msg = (explorer_interfaces__action__Discover_SendGoal_Request *)malloc(sizeof(explorer_interfaces__action__Discover_SendGoal_Request));
  if (!msg) {
    return NULL;
  }
...
explorer_interfaces__action__Discover_SendGoal_Request__Sequence__init(explorer_interfaces__action__Discover_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (explorer_interfaces__action__Discover_SendGoal_Request *)calloc(size, sizeof(explorer_interfaces__action__Discover_SendGoal_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  explorer_interfaces__action__Discover_SendGoal_Request__Sequence * array = (explorer_interfaces__action__Discover_SendGoal_Request__Sequence *)malloc(sizeof(explorer_interfaces__action__Discover_SendGoal_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  explorer_interfaces__action__Discover_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    explorer_interfaces__action__Discover_SendGoal_Request * data =
      (explorer_interfaces__action__Discover_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!explorer_interfaces__action__Discover_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          explorer_interfaces__action__Discover_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  explorer_interfaces__action__Discover_SendGoal_Response * msg = (explorer_interfaces__action__Discover_SendGoal_Response *)malloc(sizeof(explorer_interfaces__action__Discover_SendGoal_Response));
  if (!msg) {
    return NULL;
  }
...
explorer_interfaces__action__Discover_SendGoal_Response__Sequence__init(explorer_interfaces__action__Discover_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (explorer_interfaces__action__Discover_SendGoal_Response *)calloc(size, sizeof(explorer_interfaces__action__Discover_SendGoal_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  explorer_interfaces__action__Discover_SendGoal_Response__Sequence * array = (explorer_interfaces__action__Discover_SendGoal_Response__Sequence *)malloc(sizeof(explorer_interfaces__action__Discover_SendGoal_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  explorer_interfaces__action__Discover_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    explorer_interfaces__action__Discover_SendGoal_Response * data =
      (explorer_interfaces__action__Discover_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!explorer_interfaces__action__Discover_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          explorer_interfaces__action__Discover_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  explorer_interfaces__action__Discover_GetResult_Request * msg = (explorer_interfaces__action__Discover_GetResult_Request *)malloc(sizeof(explorer_interfaces__action__Discover_GetResult_Request));
  if (!msg) {
    return NULL;
  }
...
explorer_interfaces__action__Discover_GetResult_Request__Sequence__init(explorer_interfaces__action__Discover_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (explorer_interfaces__action__Discover_GetResult_Request *)calloc(size, sizeof(explorer_interfaces__action__Discover_GetResult_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  explorer_interfaces__action__Discover_GetResult_Request__Sequence * array = (explorer_interfaces__action__Discover_GetResult_Request__Sequence *)malloc(sizeof(explorer_interfaces__action__Discover_GetResult_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  explorer_interfaces__action__Discover_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    explorer_interfaces__action__Discover_GetResult_Request * data =
      (explorer_interfaces__action__Discover_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!explorer_interfaces__action__Discover_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          explorer_interfaces__action__Discover_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  explorer_interfaces__action__Discover_GetResult_Response * msg = (explorer_interfaces__action__Discover_GetResult_Response *)malloc(sizeof(explorer_interfaces__action__Discover_GetResult_Response));
  if (!msg) {
    return NULL;
  }
...
explorer_interfaces__action__Discover_GetResult_Response__Sequence__init(explorer_interfaces__action__Discover_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (explorer_interfaces__action__Discover_GetResult_Response *)calloc(size, sizeof(explorer_interfaces__action__Discover_GetResult_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  explorer_interfaces__action__Discover_GetResult_Response__Sequence * array = (explorer_interfaces__action__Discover_GetResult_Response__Sequence *)malloc(sizeof(explorer_interfaces__action__Discover_GetResult_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  explorer_interfaces__action__Discover_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    explorer_interfaces__action__Discover_GetResult_Response * data =
      (explorer_interfaces__action__Discover_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!explorer_interfaces__action__Discover_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          explorer_interfaces__action__Discover_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  explorer_interfaces__action__Discover_FeedbackMessage * msg = (explorer_interfaces__action__Discover_FeedbackMessage *)malloc(sizeof(explorer_interfaces__action__Discover_FeedbackMessage));
  if (!msg) {
    return NULL;
  }
...
explorer_interfaces__action__Discover_FeedbackMessage__Sequence__init(explorer_interfaces__action__Discover_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (explorer_interfaces__action__Discover_FeedbackMessage *)calloc(size, sizeof(explorer_interfaces__action__Discover_FeedbackMessage));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  explorer_interfaces__action__Discover_FeedbackMessage__Sequence * array = (explorer_interfaces__action__Discover_FeedbackMessage__Sequence *)malloc(sizeof(explorer_interfaces__action__Discover_FeedbackMessage__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  explorer_interfaces__action__Discover_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    explorer_interfaces__action__Discover_FeedbackMessage * data =
      (explorer_interfaces__action__Discover_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!explorer_interfaces__action__Discover_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          explorer_interfaces__action__Discover_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
